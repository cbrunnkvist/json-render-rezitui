...
/**
 * Terminal-specific default rules for AI prompts.
 * These constraints ensure generated UIs work well in terminal environments.
 */
const terminalDefaultRules = [
  // Terminal viewport constraints
...
/**
 * The schema for @cbrunnkvist/json-render-rezitui
 *
 * Defines:
...
export const schema = defineSchema(
  ...
  }),
  {
    ...
    defaultRules: [
      ...
      ...terminalDefaultRules,
    ],
  },
);

/**
 * Type for the Rezi schema
 */
export type ReziSchema = typeof schema;

/**
 * Infer the spec type from a Rezi catalog
 */
export type ReziSpec<TCatalog> = typeof schema extends {
